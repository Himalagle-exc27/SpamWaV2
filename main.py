...
os.system("clear")
autoketik(f"{biru}[{kuning}Warning{biru}] {W}Jangan Lupa Subscribe Channel Himalaglebruhv")
time.sleep(3)
os.system("xdg-open https://youtube.com/@himalagle-exc27?si=qAc3SE4bKMjI2dvs")
...
{abu}-----------------------------------------
{putih}[{biru}•{putih}] {biru}Author {putih}   : Himalaglebruhv
{putih}[{biru}•{putih}] {abu}GitHub {putih}   : Himalagle-exc27
{putih}[{biru}•{putih}] {merah}You{putih}Tube {putih}  : Himalagle-exc27
{putih}[{biru}•{putih}] {ungu}Whatsapp {putih}: +6281219197281
